                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return Padding(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(
            context, MaterialPageRoute(builder: (context) => DetailScreen(menu: menu) ));
                              },
                              child: Container(
                                  width: 285,
                                  height: 257,
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              children: [
                                Text(menu.name,style: GoogleFonts.poppins(fontWeight: FontWeight.w600, fontSize: 20),),
                                Padding(padding: const EdgeInsets.only(bottom: 10), child: Text(menu.location, style: GoogleFonts.poppins(fontWeight: FontWeight.w600, fontSize: 20)),),
                                Text(menu.about , style: GoogleFonts.poppins(fontWeight: FontWeight.w400, fontSize: 16, color: const Color.fromRGBO(105, 104, 104, 1.000),),)
                              ],
                            )
