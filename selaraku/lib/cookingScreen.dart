...
class CookingScreen extends StatelessWidget {
  CookingScreen({super.key, required this.menu});
  final AllMenu menu;
                    ...
                    child: SafeArea(child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Image(image: AssetImage(menu.ingredientImage[index]), width: 130, height: 97,),
                            Text(menu.ingredient[index],style: GoogleFonts.poppins(fontWeight: FontWeight.w500, fontSize: 16),),
                            Text(menu.ingredientDetail[index], style: GoogleFonts.poppins(fontWeight: FontWeight.w500, fontSize: 13,color: const Color.fromRGBO(164, 164, 164, 1.000)),)
                          ],
                        );
                      },
                    ),),
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        decoration: BoxDecoration(
                            ...
                            color: const Color.fromRGBO(219, 73, 51, 1.000)),
                          child: Center(
                            child: Text(
                              "Step ${index+1}",
                              style: GoogleFonts.poppins(
